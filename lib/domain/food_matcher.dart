...
class FoodMatcher {
  ...
  static const _aliases = <String, String>{
    ...
    'walnuts': 'nuts',
    'peanuts': 'nuts',
    // Common foods that are nutritionally the same thing as something the
    // catalogue already holds. Cheaper and more honest than a new row: a row
    // has to be scored and maintained, an alias just says "this is that".
    'waffles': 'pancakes',
    'waffle': 'pancakes',
    'crepe': 'pancakes',
    'crepes': 'pancakes',
